		...
		for l in range( 2, len(pyramids) ) :
			...
			while 1 :
				while 1 :
					...
					ccd_24net_1	= N24.h_fc1.eval( feed_dict={ N24.x:batch_reshape, N24.in_12net:ccd_12net } )
					ccd_24net	= np.concatenate( [ccd_12net, ccd_24net_1], axis = 3 )
					y_val = sess.run(N48.y_conv, feed_dict={N48.x:batch_reshape, N48.in_24net:ccd_24net } )
